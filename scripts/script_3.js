...
for (var i = 0; i < eventUpcoming.length; i++) {
  card[i].textContent = eventUpcoming[i].name
  description[i].textContent = eventUpcoming[i].description
  price[i].textContent = "$ " + eventUpcoming[i].price
